"""The analyze module uses the Flesch-Kincaid readability test to analyze text and
    prouce a readbility score. This score is then converted into a
...
def count_syllables_in_word(word):
    """This function takes a word in the form of a string
        and returns the number of syllable. Note this function is 
...
def compute_readability(text):
    """This function takes string of any length and prints out a
